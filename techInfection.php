      ...
      <?php if (isset($_SESSION['name']) && isset($_SESSION['email'])) { ?>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right " aria-labelledby="navbarDropdownMenuLink">
            ...
            <p class="dropdown-item text-secondary text-dark font-weight-bold"> <?php echo $_SESSION['email']; ?></p>
            <div class="dropdown-divider"></div>
            <button type="button" class="btn btn-custom-hover btn-danger ml-3" data-toggle="modal" data-target="#loginModal">&nbspLog Out&nbsp</button>
          </div>
        </li>
      <?php } else { ?>
        <li class="nav-item">
